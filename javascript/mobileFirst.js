function isMobile() {
  ...
  function resizeIconsFooter(){
      ...
      for(i=0; i<containerLinksSocialMedia.children.length; i++){
        console.log(containerLinksSocialMedia.children[i])
        containerLinksSocialMedia.children[i].children[0].classList.remove("fa-3x")
        containerLinksSocialMedia.children[i].children[0].classList.add("fa-2x")
      }
  }
